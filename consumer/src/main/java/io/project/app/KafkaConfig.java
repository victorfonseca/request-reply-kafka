...
public class KafkaConfig {
    ...
    @Bean
    public ReplyingKafkaTemplate<String, UserRequest, UserRequest> replyKafkaTemplate(
            ProducerFactory<String, UserRequest> pf, KafkaMessageListenerContainer<String, UserRequest> container) {
